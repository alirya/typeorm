...
import StdTable from "../../../../dist/table/standard";
...
it('manual', (done)=>{
    ...
    let parentColumn = Join(query, new Parameter(Entity(query, GrandParent), 'id'), new Parameter(new StdTable(Parent, 'P'), 'parent'));

    Equal(query, new Parameter(parentColumn.table, 'id'), parent.id);
